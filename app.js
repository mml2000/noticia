...
const internacinales = document.getElementById("internacionales");
...
noticias.forEach(noticia => {
  if (noticia.tipoNacional){
    ...
    const titulo = document.createTextNode(noticia.titulo);
    const imgUrl = noticia.imgUrl;
    const descripcion = document.createTextNode(noticia.descripcion);
    const fecha = document.createTextNode(noticia.fecha);
  
    h2.appendChild(titulo);
    img.src = imgUrl;
    p.appendChild(descripcion);
    span.appendChild(fecha);

    articulo.appendChild(h2);
    articulo.appendChild(img);
    articulo.appendChild(p);
    articulo.appendChild(span);
    nacionales.appendChild(articulo);
  }else{
    const articulo = document.createElement("article");
    const h2 = document.createElement("h2");
    const img = document.createElement("img");
    ...
    articulo.appendChild(p);
    articulo.appendChild(span);
    internacinales.appendChild(articulo);
  }
})
